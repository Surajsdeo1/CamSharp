        ...
        {bookings.map((booking,index)=>(
            <div key={index} className='bg-sky-300 '>
                ...
                <div className="max-w-md mx-auto bg-sky-400 w-80 shadow-lg rounded-lg overflow-hidden mt-5">
                    <div className=" PaymentId-UserDetails text-white text-center py-4" ></div>
                        
                        <h2 className="text-xl font-bold">{booking.name} : <span className='ml-4'>{booking.productId}</span></h2>
                    </div>
                    <div   className={`Details-Section pl-4 pr-4 pt-2  pb-1 bg-slate-200 w-72 ml-4 shadow-inner shadow-blue-500 transition-max-height duration-500 ease-in-out `}>
