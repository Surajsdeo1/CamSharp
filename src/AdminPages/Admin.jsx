    ...
    return (
        <div className="bg-sky-300  min-h-screen pb-12">
                ...
                <div className="flex items-center justify-center mb-6">
                    <div className="bg-sky-400 p-8 max-w-lg w-80 rounded-lg shadow-inner shadow-blue-500 transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl ">
                        ...
                        <div className="text-center mb-6 pt-2">
                            ...
                            <div className="Container bg-slate-200 shadow-lg shadow-black rounded-full w-40 h-40 ml-8">

                            </div>
                            <div className="Profile-Div absolute top-36 mt-2   left-20 ml-1  w-40 h-40 rounded-full overflow-hidden drop-shadow-xl shadow-inner shadow-blue-500">
            ...
            {sortedRecentBooking.map((booking, index) => (
                ...
                <div key={index} className="Booking-Card bg-sky-400 shadow-lg shadow-sky-400 w-80 h-auto rounded-md mt-4 mb-6 ml-6">
