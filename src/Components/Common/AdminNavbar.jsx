...
function AdminNavbar() {
    ...
    const logoutButtonHandle = () => {
      ...
      return (
        <>
          {token && (
      <div className='fixed bottom-0 w-full  sm:w-72 md:w-full bg-sky-500 flex justify-center items-center p-2 rounded-lg'>
      <i className="fi fi-bs-sign-out-alt text-4xl hover:cursor-pointer text-black " onClick={logoutButtonHandle}></i>
  </div>
